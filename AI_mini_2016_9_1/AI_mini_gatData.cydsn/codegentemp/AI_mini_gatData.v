// ======================================================================
// AI_mini_gatData.v generated from TopDesign.cysch
// 08/31/2016 at 11:59
...
module ADC_SAR_v3_0_2 (
	...
	cy_clock_v1_0
		#(.id("2762c70a-4cd4-4ce1-b951-8fb445b50945/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2762c70a-4cd4-4ce1-b951-8fb445b50945/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=4, CounterSize=16, CounterSizeReplacementString=int16, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec_1, CY_INSTANCE_SHORT_NAME=QuadDec_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=QuadDec_1, )
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("4d2e2d1c-56bd-40b0-905b-3d8488e37b09"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("25adf2ee-4f09-464c-a632-039c7b088212"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__in_Z_net;
	wire [0:0] tmpIO_0__in_Z_net;
	wire [0:0] tmpINTERRUPT_0__in_Z_net;
	electrical [0:0] tmpSIOVREF__in_Z_net;

	cy_psoc3_pins_v1_10
		#(.id("b8603200-dff2-46a1-a9c7-02ec4bab384b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		in_Z
		 (.oe(tmpOE__in_Z_net),
		  .y({1'b0}),
		  .fb({Net_977}),
		  .io({tmpIO_0__in_Z_net[0:0]}),
		  .siovref(tmpSIOVREF__in_Z_net),
		  .interrupt({tmpINTERRUPT_0__in_Z_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__in_Z_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("7488bdbd-0af9-4d30-a73f-e688f1812630"),
	...
	cy_psoc3_pins_v1_10
		#(.id("60ba1997-d5e8-4c4e-84ad-57a7a3946e6f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__in_A_net;
	wire [0:0] tmpIO_0__in_A_net;
	wire [0:0] tmpINTERRUPT_0__in_A_net;
	electrical [0:0] tmpSIOVREF__in_A_net;
	...
	cy_psoc3_pins_v1_10
		...
		in_A
		 (.oe(tmpOE__in_A_net),
		  .y({1'b0}),
		  .fb({Net_71}),
		  .io({tmpIO_0__in_A_net[0:0]}),
		  .siovref(tmpSIOVREF__in_A_net),
		  .interrupt({tmpINTERRUPT_0__in_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__in_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__in_B_net;
	wire [0:0] tmpIO_0__in_B_net;
	wire [0:0] tmpINTERRUPT_0__in_B_net;
	electrical [0:0] tmpSIOVREF__in_B_net;

	cy_psoc3_pins_v1_10
		#(.id("5353c4cf-d93e-48d2-b87a-09c7ee91452f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		in_B
		 (.oe(tmpOE__in_B_net),
		  .y({1'b0}),
		  .fb({Net_72}),
		  .io({tmpIO_0__in_B_net[0:0]}),
		  .siovref(tmpSIOVREF__in_B_net),
		  .interrupt({tmpINTERRUPT_0__in_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__in_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("8b3bd944-c091-40d1-aa25-220a58556c61"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f0fdc16a-0960-405d-b56c-9184e57cb422"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("2920dcdc-6e7f-4500-9c43-c340f92b9bfd"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9be8d90b-df96-4d8d-a57d-b3a682401494"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    assign Net_947 = ~Net_2621;

	wire [0:0] tmpOE__IN_H_net;
	wire [0:0] tmpFB_0__IN_H_net;
	wire [0:0] tmpIO_0__IN_H_net;
	wire [0:0] tmpINTERRUPT_0__IN_H_net;
	electrical [0:0] tmpSIOVREF__IN_H_net;
	...
	cy_psoc3_pins_v1_10
		...
		IN_H
		 (.oe(tmpOE__IN_H_net),
		  .y({Net_973}),
		  .fb({tmpFB_0__IN_H_net[0:0]}),
		  .io({tmpIO_0__IN_H_net[0:0]}),
		  .siovref(tmpSIOVREF__IN_H_net),
		  .interrupt({tmpINTERRUPT_0__IN_H_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IN_H_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
