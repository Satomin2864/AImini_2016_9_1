// ======================================================================
// AI_mini_bace.v generated from TopDesign.cysch
// 08/29/2016 at 11:13
...
module top ;
	...
	wire [0:0] tmpOE__SB_net;
	wire [0:0] tmpFB_0__SB_net;
	wire [0:0] tmpIO_0__SB_net;
	wire [0:0] tmpINTERRUPT_0__SB_net;
	electrical [0:0] tmpSIOVREF__SB_net;

	cy_psoc3_pins_v1_10
		#(.id("fe64e8d6-992d-4b63-94c4-3cc495ba91c7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SB
		 (.oe(tmpOE__SB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SB_net[0:0]}),
		  .io({tmpIO_0__SB_net[0:0]}),
		  .siovref(tmpSIOVREF__SB_net),
		  .interrupt({tmpINTERRUPT_0__SB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__in_button_net;
	wire [0:0] tmpFB_0__in_button_net;
	wire [0:0] tmpIO_0__in_button_net;
	wire [0:0] tmpINTERRUPT_0__in_button_net;
	electrical [0:0] tmpSIOVREF__in_button_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9be8d90b-df96-4d8d-a57d-b3a682401494"),
		  ...
		  .input_buffer_sel(2'b00))
		in_button
		 (.oe(tmpOE__in_button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__in_button_net[0:0]}),
		  .io({tmpIO_0__in_button_net[0:0]}),
		  .siovref(tmpSIOVREF__in_button_net),
		  .interrupt({tmpINTERRUPT_0__in_button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__in_button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
