...
*  The ADC_SAR_Seq_Sleep() routine saves the current component state,
...
*
* Global Variables:
*  ADC_SAR_Seq_backup - The structure field 'enableState' is modified
*  depending on the enable state of the block before entering to sleep mode.
*
*******************************************************************************/
void ADC_SAR_Seq_Sleep(void)
{
    if((ADC_SAR_Seq_PWRMGR_SAR_REG  & ADC_SAR_Seq_ACT_PWR_SAR_EN) != 0u)
    {
        if((ADC_SAR_Seq_SAR_CSR0_REG & ADC_SAR_Seq_SAR_SOF_START_CONV) != 0u)
        {
...
*  ADC_SAR_Seq_Sleep() was called. If the component was enabled before the
*  ADC_SAR_Seq_Sleep() function was called, the
*  ADC_SAR_Seq_Wakeup() function also re-enables the component.
*
* Parameters:
*  None.
*
...
*
* Global Variables:
*  ADC_SAR_Seq_backup - The structure field 'enableState' is used to
